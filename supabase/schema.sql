...
create table if not exists access_profile_permissions (
  ...
  screen_key text not null check (screen_key in ('dashboard','agenda','solicitacao','relatorios','validacoes')), can_view boolean not null default false, can_edit boolean not null default false,
