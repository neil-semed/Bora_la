...
drop policy if exists "drivers_select_by_role" on drivers;
...
drop policy if exists "cooperativas_select_by_role" on cooperativas;
...
drop policy if exists "excursion_drivers_select_by_role" on excursion_drivers;
...
drop policy if exists "pcd_students_select_by_role" on excursion_pcd_students;
...
drop policy if exists "passengers_select_by_role" on excursion_passengers;
