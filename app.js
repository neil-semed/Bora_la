...
function filterAgenda() {
  ...
  // A aba "Hoje" do motorista é sempre pessoal: somente as próprias viagens
  // confirmadas, no dia corrente. A visão de todos fica exclusivamente em Agenda Geral.
  if (currentUser?.role === 'motorista') {
    const hoje = fmtDate(new Date());
    return agenda.filter((a) => viagemConfirmadaParaMotorista(a)
