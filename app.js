...
function pendenciaDataHora(a) {
  ...
  return `<span>${data}</span><span class="mx-1 text-slate-300">|</span><strong class="text-sm text-slate-800">${horario}</strong>${criado ? `<span class="text-slate-400"> · solicitado em ${criado}</span>` : ''}`;
}
