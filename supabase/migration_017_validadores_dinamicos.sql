...
-- O gatilho de segurança das viagens é destinado às chamadas do aplicativo. O
-- backfill abaixo é uma manutenção administrativa e precisa preencher as novas
-- referências das viagens já existentes; reativamos o gatilho logo em seguida.
