...
function renderAgendaPorData() {
  ...
  // Próximas agendas do motorista: visão operacional de todas as viagens já
  // confirmadas pelo Admin, inclusive quando outro condutor estiver escalado.
  const fonte = currentUser?.role === 'motorista' ? agenda.filter(viagemConfirmadaParaMotorista) : getVisibleAgenda();
